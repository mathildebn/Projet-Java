...
public class Fenetre extends JFrame implements ActionListener, ItemListener {
    ...
    private void remplirTables() {
        ...
        maconnexion.ajouterTable("seance_enseignant");
        maconnexion.ajouterTable("seance_groupe");
        maconnexion.ajouterTable("seance_salles");
        maconnexion.ajouterTable("site");
        maconnexion.ajouterTable("type_cours");
        maconnexion.ajouterTable("utilisateurs");
    ...
    private void remplirRequetes() {
        //maconnexion.ajouterRequete("select Id_seance from seance_groupe ;");
        maconnexion.ajouterRequete("SELECT nom from utilisateurs");
        maconnexion.ajouterRequete("SELECT nom_salle from salle;");
        maconnexion.ajouterRequete("SELECT nom_groupe from groupe;");
